...
function RoomState_Save(_room) {
    ...
    var interact_fields = ["interact_kind","sprite_id","sprite_index","chest_id","chest_item_id","chest_qty","switch_id","npc_id","shop_id","checkpoint_id","door_room","door_x","door_y"];
