function EnemyDB_Init() {
    ...
    global.enemy_db[? ENEMY_SPIDER] = {
        ...
        name: "Spider",
        level: 3,
        stats: { str: 11, agi: 12, def: 10, intt: 6, luck: 9 },
        base_hp: 10,
        base_mp: 0,
        hd: 8,
        mp_gain: 0,
    ...
    global.enemy_db[? ENEMY_SNAKE] = {
        ...
        name: "Snake",
        level: 3,
        stats: { str: 10, agi: 11, def: 9, intt: 6, luck: 8 },
        base_hp: 10,
        base_mp: 0,
        hd: 8,
        mp_gain: 0,
    ...
    global.enemy_db[? ENEMY_MADWHISP] = {
        ...
        name: "Mad Whisp",
        level: 4,
        stats: { str: 8, agi: 12, def: 9, intt: 15, luck: 11 },
        base_hp: 8,
        base_mp: 10,
        hd: 6,
        mp_gain: 2,
    ...
    global.enemy_db[? ENEMY_KILLER_PLANT] = {
        ...
        name: "Killer Plant",
        level: 4,
        stats: { str: 14, agi: 8, def: 14, intt: 12, luck: 8 },
        base_hp: 12,
        base_mp: 6,
        hd: 8,
        mp_gain: 1,
    ...
    global.enemy_db[? ENEMY_DIREWOLF] = {
        ...
        name: "Dire Wolf",
        level: 5,
        stats: { str: 17, agi: 15, def: 12, intt: 7, luck: 9 },
        base_hp: 12,
        base_mp: 0,
        hd: 8,
        mp_gain: 0,
    ...
    global.enemy_db[? ENEMY_GHOSTSWORD] = {
        ...
        name: "Ghost Sword",
        level: 5,
        stats: { str: 18, agi: 11, def: 14, intt: 10, luck: 12 },
        base_hp: 12,
        base_mp: 4,
        hd: 8,
        mp_gain: 1,
    ...
    global.enemy_db[? ENEMY_STRANGER] = {
        ...
        name: "Stranger",
        level: 6,
        stats: { str: 20, agi: 15, def: 16, intt: 18, luck: 14 },
        base_hp: 14,
        base_mp: 8,
        hd: 8,
        mp_gain: 2,
    ...
    global.enemy_db[? ENEMY_MINI_BOSS] = {
        ...
        name: "Mini Boss",
        level: 7,
        stats: { str: 23, agi: 13, def: 18, intt: 16, luck: 14 },
        base_hp: 18,
        base_mp: 8,
        hd: 10,
        mp_gain: 2,
    ...
    global.enemy_db[? ENEMY_FINAL_BOSS] = {
        ...
        name: "Final Boss",
        level: 8,
        stats: { str: 26, agi: 14, def: 22, intt: 24, luck: 16 },
        base_hp: 22,
        base_mp: 12,
        hd: 10,
        mp_gain: 3,
