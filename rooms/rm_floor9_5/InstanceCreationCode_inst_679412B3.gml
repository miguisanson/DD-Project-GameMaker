dialogue_id = "first_encounter_final_boss";
...
lock_mode = "freeze";
lock_enemy_object = obj_final_boss;
lock_enemy_tag = "floor9_5_intro_final_boss";
...
camera_focus_object = obj_final_boss;
camera_focus_tag = "floor9_5_intro_final_boss";
